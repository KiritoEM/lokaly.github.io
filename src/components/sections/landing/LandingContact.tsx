...
const LandingContact = (): JSX.Element => {
    ...
    return (
        <section className={`landing__contact bg-cover bg-no-repeat bg-center w-full overflow-hidden`} style={{ backgroundImage: `url(${backgroundImageUrl})` }} id="contact" ref={ref}>
                ...
                <div className="flex flex-col md:flex-row  items-end gap-12 md:gap-10 relative z-30">
                    ...
                    >
                        <div className="cat relative z-40 top-8 flex justify-end">
                            <img src={`${process.env.NODE_ENV === "production" ? process.env.NEXT_BASE_PATH : ""}/cat.svg`} alt="" />
                        </div>
